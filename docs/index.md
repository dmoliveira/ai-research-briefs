  ...
  <div class="hero-grid">
    <div class="hero-copy">
      ...
      <div class="hero-actions">
        <a class="button primary" href="2026/08/2026-08-05.html">Open latest brief</a>
...
<section class="metrics-ribbon">
  ...
  <article class="metric-block">
    ...
    <span class="metric-copy"><span class="metric-label">Briefs</span><strong class="metric-value">23</strong><span class="metric-sub">Total issues</span></span>
  </article>
  <article class="metric-block">
    <span class="metric-icon">◫</span>
    <span class="metric-copy"><span class="metric-label">Papers archived</span><strong class="metric-value">384</strong><span class="metric-sub">Across all briefs</span></span>
  </article>
  <article class="metric-block">
    <span class="metric-icon">◌</span>
...
<section class="home-section discovery-section">
  ...
  <div class="discovery-grid">
    <article class="discovery-card latest-brief-card">
      ...
      <p class="meta">2026-08-05 · 10 papers</p>
      <h3><a href="2026/08/2026-08-05.html">AI Research Brief: 2026-08-05</a></h3>
      <p class="digest-summary">Weekly issue covering high-signal AI research and engineering work published or newly updated between July 29 and August 5, 2026, with emphasis on agent failure detection, evaluation reliability, agentic RAG discipline, long-horizon memory, LLM serving observability, coding-agent runtime state, and recommender systems.</p>
      <div class="digest-meta-cluster">
        <span class="digest-meta-chip">Aug 05, 2026</span>
        <span class="digest-meta-chip">10 papers</span>
        <span class="digest-meta-chip">Verified window</span>
      </div>
      <div class="pill-row"><span class="pill">agents</span><span class="pill">llm</span><span class="pill">evaluation</span><span class="pill">recommender-systems</span><span class="pill">rag</span></div>
      <a class="text-link" href="2026/08/2026-08-05.html">Read full brief</a>
    </article>
    <aside class="feature-panel">
      ...
      <ol class="featured-paper-list">
        <li><span class="featured-rank">1</span><span>Ledger</span></li>
        <li><span class="featured-rank">2</span><span>Real-Time Detection and Repair</span></li>
        <li><span class="featured-rank">3</span><span>Judging Is Not Enumerating</span></li>
        <li><span class="featured-rank">4</span><span>TELLER</span></li>
      </ol>
      <a class="text-link" href="2026/08/2026-08-05.html">View all 10 papers</a>
    </aside>
  </div>
</section>
<section class="home-section">
  <div class="section-heading-row">
    ...
    <a class="section-heading-link" href="2026/08/2026-08-05.html">From latest issue</a>
  </div>
  <div class="theme-tile-grid">
    <article class="theme-tile" data-theme="agents">
      ...
      <strong>Seen in 23 briefs</strong>
    </article>
...
<section class="home-section" id="recent-briefs">
  ...
  <div class="archive-ledger">
    ...
    <article class="archive-ledger-row">
      <span class="archive-date">2026-07-17</span>
      <span class="archive-count">18 items</span>
      <span class="archive-themes"><span class="theme-dot-row"><span class="theme-dot" title="Agents">◎</span><span class="theme-dot" title="LLM">◌</span><span class="theme-dot" title="Evaluation">◇</span><span class="theme-dot" title="Recommender Systems">•</span><span class="theme-dot" title="Safety">•</span></span><span class="archive-theme-labels">Agents, LLM, Evaluation, Recommender Systems, Safety</span></span>
      <a class="archive-open" href="2026/07/2026-07-17.html" aria-label="Open AI Research Brief: 2026-07-17">Open issue</a>
    </article>
  </div>
</section>